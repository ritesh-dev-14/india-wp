    ...
    <div className="bg-[#FAF8F5] text-[#1E1B18] min-h-screen selection:bg-[#E05A47] selection:text-white font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-[85vh] flex flex-col justify-end px-[5vw] pb-20 pt-32 border-b border-[#E8E2D9]">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-t border-[#E8E2D9] pt-8">
      ...
      <section className="px-[5vw] py-24 border-b border-[#E8E2D9]">
        <div className="max-w-[1400px] mx-auto">
          <motion.div 
            ...
            className="mb-16"
          >
            <motion.span variants={fadeUp} className="block font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] mb-4 font-semibold">
              What We Do
            </motion.span>
            <motion.h2 variants={fadeUp} className="text-[clamp(32px,4vw,64px)] leading-[1.1] font-extrabold tracking-tight">
              ...
              >
                ...
                <div className="hidden md:flex flex-col gap-2 w-1/3 z-10 opacity-60 group-hover:opacity-100 transition-opacity duration-500">
                  {cap.services.map(service => (
                    <span key={service} className="font-mono text-[11px] tracking-[0.1em] uppercase text-[#5C5346]">
                      {service}
                    </span>
                  ))}
                </div>
                ...
                <div className="hidden md:flex items-center justify-end w-1/4 z-10 pr-8">
                  <ArrowRight className="w-8 h-8 text-transparent -translate-x-8 group-hover:text-[#E05A47] group-hover:translate-x-0 transition-all duration-500 ease-out" strokeWidth={1.5} />
                </div>
                ...
                <AnimatePresence>
                  {hoveredCapability === i && (
                    ...
                    >
                      <img src={cap.image} alt={cap.title} className="w-full h-full object-cover filter contrast-105" />
                    </motion.div>
                  )}
                </AnimatePresence>
              </motion.div>
      ...
      <section className="px-[5vw] py-24 flex flex-col gap-28 border-b border-[#E8E2D9]">
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-[1400px] mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 items-center">
          <div className="flex flex-col gap-6">
            <span className="font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] font-semibold">01 / Strategy</span>
            <h2 className="text-[clamp(40px,5vw,80px)] leading-[1.05] tracking-tight font-extrabold text-[#1E1B18]">Start with<br/>the right direction.</h2>
          </div>
          <div className="flex flex-col justify-end gap-8 md:pl-16">
            ...
            <Link to="/contact" className="inline-flex items-center gap-3 font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] hover:text-[#1E1B18] transition-colors font-bold mt-2">
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-[1400px] mx-auto w-full flex flex-col md:flex-row-reverse gap-12 md:gap-20 items-center">
          <div className="w-full md:w-1/2 flex flex-col gap-6">
            <span className="font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] font-semibold">02 / Creative</span>
            <h2 className="text-[clamp(40px,5vw,80px)] leading-[1.05] tracking-tight font-extrabold text-[#1E1B18]">Make people<br/>stop scrolling.</h2>
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-3 font-mono text-[11px] tracking-[0.15em] uppercase text-[#5C5346] font-medium pt-2">
              <span className="bg-white px-3 py-1 rounded-md border border-[#E8E2D9]">Brand Identity</span> 
              <span className="bg-white px-3 py-1 rounded-md border border-[#E8E2D9]">Art Direction</span> 
              <span className="bg-white px-3 py-1 rounded-md border border-[#E8E2D9]">UI / UX</span> 
              <span className="bg-white px-3 py-1 rounded-md border border-[#E8E2D9]">Campaign Design</span>
            </div>
            <Link to="/contact" className="inline-flex items-center gap-3 font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] hover:text-[#1E1B18] transition-colors font-bold mt-2">
          ...
          <div className="w-full md:w-1/2 aspect-[4/3] md:aspect-[4/3] overflow-hidden rounded-2xl border border-[#E8E2D9] shadow-sm">
            <img src="https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&w=1200&auto=format&fit=crop" alt="Creative Design" className="w-full h-full object-cover filter contrast-105" />
          </div>
        </motion.div>

        {/* 03: TECHNOLOGY (Clean Technical Vibe) */}
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-[1400px] mx-auto w-full bg-white p-8 md:p-16 border border-[#E8E2D9] rounded-2xl shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
             <div className="flex flex-col gap-6">
                <span className="font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] font-semibold">03 / Technology</span>
                <h2 className="text-[clamp(40px,5vw,80px)] leading-[1.05] tracking-tight font-extrabold text-[#1E1B18]">Turn ideas into<br/>experiences.</h2>
             </div>
             <div className="flex flex-col justify-end gap-8">
                ...
                <div className="grid grid-cols-2 gap-4 font-mono text-[11px] tracking-[0.15em] uppercase text-[#5C5346] font-medium">
                  <span className="border border-[#E8E2D9] bg-[#FAF8F5] p-4 rounded-xl">Website Development</span>
                  <span className="border border-[#E8E2D9] bg-[#FAF8F5] p-4 rounded-xl">Web Applications</span>
                  <span className="border border-[#E8E2D9] bg-[#FAF8F5] p-4 rounded-xl">Interactive Experiences</span>
                  <span className="border border-[#E8E2D9] bg-[#FAF8F5] p-4 rounded-xl">Digital Products</span>
                </div>
                <Link to="/contact" className="inline-flex items-center gap-3 font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] hover:text-[#1E1B18] transition-colors font-bold mt-2">
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-[1400px] mx-auto w-full text-center flex flex-col items-center justify-center gap-8">
           <span className="font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] font-semibold">04 / Growth</span>
           <h2 className="text-[clamp(40px,7vw,100px)] leading-[0.95] tracking-tight font-extrabold max-w-5xl uppercase text-[#1E1B18]">
             Create attention.<br/>
             <span className="text-[#E05A47] italic font-serif lowercase font-normal" style={{ fontFamily: "'Instrument Serif', serif" }}>Then create</span> momentum.
           </h2>
           ...
           <div className="flex flex-wrap justify-center gap-6 font-mono text-[11px] tracking-[0.15em] uppercase text-[#5C5346] font-medium">
              <span className="bg-white px-4 py-2 rounded-md border border-[#E8E2D9]">Social Media</span> 
              <span className="bg-white px-4 py-2 rounded-md border border-[#E8E2D9]">Digital Marketing</span> 
              <span className="bg-white px-4 py-2 rounded-md border border-[#E8E2D9]">Performance</span> 
              <span className="bg-white px-4 py-2 rounded-md border border-[#E8E2D9]">SEO</span>
           </div>
           <Link to="/contact" className="inline-flex items-center gap-3 font-mono text-[11px] tracking-[0.2em] uppercase mt-4 text-[#E05A47] hover:text-[#1E1B18] font-bold transition-colors">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-5xl gap-4 md:gap-0">
            {FLOW.map((step, i) => (
              <React.Fragment key={step}>
                <motion.div variants={fadeUp} className="flex flex-col items-center justify-center bg-white px-6 py-4 rounded-xl border border-[#E8E2D9] shadow-xs w-full md:w-auto">
                ...
                {i !== FLOW.length - 1 && (
                  <motion.div variants={fadeUp} className="w-0.5 h-6 md:w-full md:h-0.5 bg-[#E8E2D9] md:flex-1 mx-2" />
                )}
              </React.Fragment>
            ))}
          </div>
            ...
            {DELIVERABLES.map((item, index) => (
              ...
              >
                <div className="flex items-center gap-8">
                  <span className="font-mono text-xs text-[#3B6A62] font-bold">{(index + 1).toString().padStart(2, '0')}</span>
      ...
      <section className="px-[5vw] py-24 bg-[#F3EFEA] border-b border-[#E8E2D9]">
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-[1400px] mx-auto">
          ...
          <motion.h2 variants={fadeUp} className="text-[clamp(32px,4vw,64px)] leading-[1.1] font-extrabold tracking-tight mb-12">
            Different industries. <br/><span className="text-[#5C5346] font-normal">Same ambition.</span>
          </motion.h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 border-t border-[#E8E2D9] pt-12">
            {INDUSTRIES.map(industry => (
              <motion.div key={industry} variants={fadeUp} className="flex flex-col bg-white p-6 rounded-xl border border-[#E8E2D9] shadow-xs">
                <span className="text-lg md:text-xl font-bold tracking-tight text-[#1E1B18]">{industry}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-[1400px] mx-auto">
          <motion.div variants={fadeUp} className="mb-16">
            ...
            <h2 className="text-[clamp(36px,4vw,72px)] leading-[1.05] tracking-tight font-extrabold max-w-3xl">
              One team.<br/>One direction.<br/><span className="text-[#5C5346] font-normal">One digital experience.</span>
            </h2>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             {PRINCIPLES.map(principle => (
               <motion.div key={principle.num} variants={fadeUp} className="flex flex-col gap-4 bg-white p-8 rounded-2xl border border-[#E8E2D9] shadow-sm">
                 <span className="font-mono text-xs text-[#3B6A62] font-bold">{principle.num}</span>
                 <h3 className="text-xl md:text-2xl font-extrabold tracking-tight text-[#1E1B18]">{principle.title}</h3>
      ...
      <section className="px-[5vw] py-32 bg-white text-center flex flex-col items-center justify-center relative">
        ...
        >
          <motion.span variants={fadeUp} className="font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] mb-6 font-semibold">
            Have a project in mind?
          </motion.span>
          
          <motion.h2 variants={fadeUp} className="text-[clamp(40px,7vw,100px)] leading-[1.05] font-extrabold tracking-tight mb-12 text-[#1E1B18]">
            Let's build <br/>
            <span className="text-[#E05A47] italic font-serif font-normal" style={{ fontFamily: "'Instrument Serif', serif" }}>something impossible</span> <br/>
            to ignore.
          </motion.h2>
          ...
          <motion.a 
            variants={fadeUp}
            href="mailto:hello@sitesparkone.com"
