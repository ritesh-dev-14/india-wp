...
import { ArrowRight, Sparkles, TrendingUp, Users, Zap, ShieldCheck } from "lucide-react";
...
const PromoteHero = () => {
  return (
    <section className="relative min-h-[92vh] flex flex-col justify-between px-[5vw] pt-32 pb-16 overflow-hidden bg-[#FAF8F5] text-[#1E1B18] border-b border-[#E8E2D9]">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.3]" style={{ backgroundImage: "linear-gradient(to right, #EFECE6 1px, transparent 1px), linear-gradient(to bottom, #EFECE6 1px, transparent 1px)", backgroundSize: "4rem 4rem" }} />
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-mono text-[10px] sm:text-[11px] tracking-[0.25em] uppercase text-[#E05A47] font-bold">
            SiteSparkOne // Growth & Promotion Engine
          </span>
        </div>
      ...
      >
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          >
            ...
            <span className="text-[#E05A47] italic font-serif font-normal" style={{ fontFamily: "'Instrument Serif', serif" }}>dominate markets.</span>
          </motion.h1>

          <motion.p variants={fadeUp} className="text-[#5C5346] text-lg md:text-xl font-light leading-relaxed max-w-xl">
            We engineer precision-targeted promotional campaigns, organic momentum, and high-conversion acquisition funnels that put your brand directly in front of high-intent buyers.
          </motion.p>
        </div>

        {/* Right side floating metric cards */}
        <motion.div variants={fadeUp} className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-white p-6 rounded-2xl border border-[#E8E2D9] shadow-sm flex flex-col justify-between">
            <span className="font-mono text-[11px] text-[#8C8375] uppercase tracking-wider">Average ROI</span>
            <div className="my-6">
              <span className="text-4xl font-extrabold tracking-tight text-[#1E1B18]">3.8x</span>
              <span className="text-[#E05A47] font-mono text-xs ml-2 font-bold">+28% YoY</span>
            </div>
            <p className="text-xs text-[#5C5346] font-light">Direct attribution across paid and organic channels.</p>
          </div>

          <div className="bg-white p-6 rounded-2xl border border-[#E8E2D9] shadow-sm flex flex-col justify-between">
            <span className="font-mono text-[11px] text-[#8C8375] uppercase tracking-wider">Reach Efficiency</span>
            <div className="my-6">
              <span className="text-4xl font-extrabold tracking-tight text-[#1E1B18]">99.4%</span>
              <span className="text-[#E05A47] font-mono text-xs ml-2 font-bold">Zero Waste</span>
            </div>
            <p className="text-xs text-[#5C5346] font-light">Hyper-segmented audience targeting models.</p>
          </div>
        </motion.div>
      </motion.div>
      ...
      >
        <div className="font-mono text-[11px] tracking-[0.2em] text-[#5C5346] uppercase font-semibold">
          Performance Marketing • Paid Media • Creator Partnerships • SEO Dominance
        </div>
  ...
  return (
    <section className="px-[5vw] py-32 md:py-40 bg-[#F3EFEA] border-b border-[#E8E2D9]">
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          <motion.span variants={fadeUp} className="font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] font-bold block mb-4">
            01 / Strategic Pillars
          </motion.span>
          <motion.h2 variants={fadeUp} className="text-[clamp(32px,4.5vw,56px)] leading-[1.1] font-extrabold tracking-tight text-[#1E1B18]">
          ...
          {pillars.map((item, index) => (
            ...
            >
              ...
              <div className="mt-12 pt-6 border-t border-[#FAF8F5] flex items-center justify-between">
                <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#8C8375]">Execution Core</span>
                <span className="font-mono text-xs font-bold text-[#E05A47]">Active Optimization</span>
              </div>
            </motion.div>
          ))}
        </div>
...
const PromotionProcess = () => {
  const steps = [
    { num: "01", title: "Audit & Positioning", desc: "We analyze your historical metrics, competitor positioning, and untapped market opportunities." },
    { num: "02", title: "Asset & Funnel Setup", desc: "We build high-converting creatives, landing pages, and tracking infrastructure." },
    { num: "03", title: "Launch & Scale", desc: "We deploy controlled budget spikes, test messaging variants, and aggressively scale what wins." },
    { num: "04", title: "Data & Iteration", desc: "Continuous refinement, cohort analysis, and ROAS enhancement to ensure long-term stability." }
  ];
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          <div>
            ...
            <motion.h2 variants={fadeUp} className="text-[clamp(32px,4vw,52px)] font-extrabold tracking-tight text-[#1E1B18]">
              How we scale your brand systematically.
            </motion.h2>
          </div>
          <motion.p variants={fadeUp} className="text-[#5C5346] text-base font-light max-w-md">
            No guessing games. Every promotional campaign follows a rigorous, data-backed roadmap designed for predictable scaling.
          </motion.p>
        </motion.div>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="mt-8 pt-4 border-t border-[#E8E2D9] flex items-center justify-between">
                <span className="font-mono text-[10px] text-[#8C8375] uppercase">Phase {step.num}</span>
...
const VisualStatement = () => {
  ...
  return (
    <section ref={container} className="h-[130vh] relative bg-[#F3EFEA] border-b border-[#E8E2D9]">
      <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden px-[5vw]">
        ...
        >
          Stop whispering. <br/>
          <span className="text-[#E05A47] italic font-serif lowercase font-normal" style={{ fontFamily: "'Instrument Serif', serif" }}>Start echoing.</span>
        </motion.h2>
      </div>
    </section>
  );
...
const PromoteCTA = () => {
  return (
    <section className="px-[5vw] py-36 bg-white text-center flex flex-col items-center justify-center border-t border-[#E8E2D9] relative overflow-hidden">
      ...
      >
        <motion.span variants={fadeUp} className="font-mono text-[11px] tracking-[0.2em] uppercase text-[#E05A47] mb-6 font-bold">
          Ready for lift-off?
        </motion.span>
        
        <motion.h2 variants={fadeUp} className="text-[clamp(36px,6.5vw,96px)] leading-[1.05] font-extrabold tracking-tight mb-6 text-[#1E1B18]">
          Let's amplify your <br/>
          <span className="text-[#E05A47] italic font-serif font-normal" style={{ fontFamily: "'Instrument Serif', serif" }}>growth metrics.</span>
        </motion.h2>

        <motion.p variants={fadeUp} className="text-[#5C5346] text-lg md:text-xl font-light mb-12 max-w-xl">
          Schedule a strategy call and let's map out your custom promotional growth engine.
        </motion.p>
        ...
        <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center gap-4">
          ...
          >
            <span className="relative z-10 flex items-center gap-3">
              Launch Campaign <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </span>
          </Link>
